...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Infosports · <?php echo($title); ?></title>
				...
				<article class="col-md-12 col-lg-9 mb-4 text-justify">
					<div class="col-12 m-1 d-flex justify-content-end">
						<div class="btn-group-vertical">
							<button class="btn btn-sm btn-primary" type="button" data-toggle="collapse" data-target="#shareCollapse" aria-expanded="false" aria-controls="shareCollapse"><span data-placement="left" title="Partager l'article" data-toggle="tooltip"><i class="fas fa-share-alt"></i></span></button>
							<div class="collapse btn-group-vertical" id="shareCollapse" style="position:absolute;top:2rem;">
								<a href="https://twitter.com/intent/tweet?original_referer=http:lepointk.cerisara.fr&source=tweetbutton&text=<?php echo($title); ?>+via+Le+Point+K+de+@Lycee_Poincare&hashtags=<?php echo($mainCategoryName); ?>&url=http://lepointk.cerisara.fr/article.php?id=<?php echo($id); ?>&via=Lycee_Poincare"
								class="btn btn-sm btn-light" data-toggle="tooltip" data-placement="left" title="Twitter"><i class="fab fa-twitter"></i></a>
								<a href="https://www.facebook.com/sharer/sharer.php?u=http://lepointk.cerisara.fr/article.php?id=<?php echo($id); ?>" class="btn btn-sm btn-light" data-toggle="tooltip" data-placement="left" title="Facebook"><i class="fab fa-facebook"></i></a>
								<!--<a href="#" class="btn btn-sm btn-light disabled" data-toggle="tooltip" data-placement="left" title="Diaspora"><i class="fab fa-diaspora"></i></a>
								<a href="#" class="btn btn-sm btn-light disabled" data-toggle="tooltip" data-placement="left" title="Mastodon"><i class="fab fa-mastodon"></i></a>-->
							</div>
						</div>
