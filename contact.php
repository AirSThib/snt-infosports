...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Infosports · Nous contacter</title>
				...
				<div class="col-sm-12 mb-4">
					<div class="row">
						<div class="col-sm-12 col-md-6">
							...
							<i class="fas fa-map-marker-alt"></i> Lycée Nelson Mandela, Pibrac, Haute-Garonne, Occitanie, France.<br />
							<a href="mailto:contact@infosports.com"><i class="fas fa-envelope"></i> contact@infosports.com</a><br />
							<i class="fas fa-phone"></i> +33 5 01 01 01 01
						</div>
						<div class="col-sm-12 col-md-6">
