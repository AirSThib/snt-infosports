		...
		<div class="col-sm-12 col-md-8">
			<div class="row">
				...
				<div class="col-sm-12 col-md-4 font-weight-bold">
					...
					<a href="https://instagram.com/infosports_off" data-toggle="tooltip" data-placement="left" data-delay="250" title="Notre compte Instagram"><i class="fab fa-instagram icon-join"></i></a>
					<a href="https://twitter.com/infosports_off" data-toggle="tooltip" data-placement="right" data-delay="250" title="Notre compte Twitter"><i class="fab fa-twitter icon-join"></i></a>
				</div>
			</div>
			<?php
