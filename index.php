	...
	<body>
		...
		<div class="jumbotron jumbotron-fluid bg-light">
			<div class="container">
				...
				<p class="lead font-italic">Le sport en accès libre</p>
			</div>
		</div>
		<div class="container">
			<div class="row">
					...
					<table class="table align-middle table-striped">
						...
						<tbody>
						  	...
						  	while ($listCategories = $listCategoriesRequest->fetch()) {
						  		...
						  		$numberArticlesCategoriesRequest = $db->prepare("SELECT * FROM articles WHERE mainCategory = :id AND published = 1");
							  	...
							  	?>
								<tr>
									<td><a href="categories.php?id=<?php echo($listCategories["id"]); ?>"><?php echo($listCategories["name"]); ?></a></td>
